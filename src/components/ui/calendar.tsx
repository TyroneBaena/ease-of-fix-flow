  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "text-muted-foreground rounded-md flex-1 min-w-0 font-normal text-[0.8rem] text-center",
        ...
        day: cn(
          ...
          "h-8 w-full max-w-[2.5rem] sm:h-9 sm:max-w-[2.25rem] p-0 font-normal aria-selected:opacity-100 text-xs sm:text-sm mx-auto"
        ),
