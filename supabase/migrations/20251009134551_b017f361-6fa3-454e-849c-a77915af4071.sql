-- Fix get_security_metrics to accept organization_id parameter
-- This allows the edge function to pass the org ID explicitly

DROP FUNCTION IF EXISTS public.get_security_metrics(INTEGER);

CREATE FUNCTION public.get_security_metrics(
