-- Fix notification type in create_comment_notifications function
-- Change type from 'comment' to 'info' to match check constraint
...
BEGIN
  ...
  -- Notify managers assigned to this property
