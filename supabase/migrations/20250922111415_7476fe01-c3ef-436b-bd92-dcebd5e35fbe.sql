...
BEGIN
  ...
  -- Log function usage
  RAISE LOG 'Public property info accessed for property: %', property_uuid;
END;
$$;
...
BEGIN
  ...
  -- Log function usage
  RAISE LOG 'Public property requests accessed for property: %, limit: %', property_uuid, request_limit;
END;
$$;