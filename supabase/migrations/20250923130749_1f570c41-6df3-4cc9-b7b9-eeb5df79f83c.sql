-- Clean up duplicate function definitions for submit_public_maintenance_request
-- Drop all existing versions and create a single clean version

-- Drop the old versions (PostgreSQL requires specific parameter signatures)
DROP FUNCTION IF EXISTS public.submit_public_maintenance_request(uuid, text, text, text, text, text, text, text, text, text, text, text);
DROP FUNCTION IF EXISTS public.submit_public_maintenance_request(uuid, text, text, text, text, text, text, text, text, text, text, text, jsonb);
DROP FUNCTION IF EXISTS public.submit_public_maintenance_request(uuid, text, text, text, text, text, text, text, text, text, text, text, text);
