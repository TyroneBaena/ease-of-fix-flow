-- Fix the ambiguous user_id reference and manually create the missing profile

DO $$
DECLARE
    target_user_id UUID := 'c655ae84-5bc3-4262-8346-1e1f43fcafb3';
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM public.profiles WHERE id = target_user_id) THEN
        ...
        org_slug := 'react' || substring(target_user_id::text, 1, 8);
        ...
        -- Create user_organizations record (fix the ambiguous reference)
        INSERT INTO public.user_organizations (
            ...
            target_user_id,  -- Use the explicitly named variable
            new_org_id,
            'admin',
            true,
            true,
