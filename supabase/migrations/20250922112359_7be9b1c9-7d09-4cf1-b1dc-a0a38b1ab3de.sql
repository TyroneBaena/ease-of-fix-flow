-- Create a secure function to submit public maintenance requests
-- This function runs with elevated privileges to bypass RLS for public submissions
...
BEGIN
  ...
  INSERT INTO public.maintenance_requests (
    ...
    p_attempted_fix,
    property_org_id,
    '00000000-0000-0000-0000-000000000001', -- Special UUID for public requests
    now(),
    now()
